...
export default {
  ...
  NOTCHPAY_WEBHOOK_SECRET_HASH_TEST: process.env.NOTCHPAY_WEBHOOK_SECRET_HASH_TEST as string,
  NOTCHPAY_WEBHOOK_SECRET_HASH_LIVE: process.env.NOTCHPAY_WEBHOOK_SECRET_HASH_LIVE as string,
};
